...
@pytest.mark.anyio
async def test_scenario_03_cylinder_z(mcp_client):
    """Scenario 03: Cylinder along Z axis."""
    f360 = FusionE2E(mcp_client)
    await f360.call_tool("create_new_design", {"name": "E2E_Cylinder_Z"})
    ...
    await f360.export_and_verify("cylinder_z")
