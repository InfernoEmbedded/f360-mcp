...
async def test_scenario_04_hollow_pipe(mcp_client):
    ...
    await f360.call_tool("add_circle", {"sketch_name": "PipeSketch", "center_x": 0, "center_y": 0, "radius": 5.0})
    await f360.call_tool("add_circle", {"sketch_name": "PipeSketch", "center_x": 0, "center_y": 0, "radius": 4.0})
